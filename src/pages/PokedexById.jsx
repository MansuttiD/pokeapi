    ...
    <article className='byid' >
      ...
      <main className='byid__main'>
        <section className='byid__section-1' >
          ...
          <h3 className='byid__subtitles'>Stats</h3>
          <div >
        ...
        <section className='byid__section-2' >
          <h3 className='byid__subtitles'>Movements</h3>
          <ul className='byid__movements'>
            {
              pokemon?.moves.map(move => (
                <li className='byid__movements-li'>{move.move.name}</li>
              ))
            }
          </ul>
        </section>
